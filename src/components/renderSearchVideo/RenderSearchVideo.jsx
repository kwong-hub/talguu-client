...
function RenderSearchVideo(props) {
  ...
  return (
    <div
      ...
      className={
        props.for
          ? 'flex flex-col md:flex-row w-full md:w-11/12 lg:w-full sm:w-6/12 p-2 cursor-pointer video_thumbnail self-stretch'
          : 'flex flex-col md:flex-row w-full md:w-11/12 lg:w-11/12 sm:w-6/12 p-2 cursor-pointer video_thumbnail self-stretch'
      }
    >
